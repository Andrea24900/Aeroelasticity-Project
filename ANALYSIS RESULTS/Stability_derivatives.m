...
%%
Stability_derivative = ["CL";"CL";"CM";"CM"];
...
beta = [(interp1(velocity_vector,C_Y_beta_elastic,15) - (-0.175))/(-0.175),...
...
delta_r = [(interp1(velocity_vector,C_Y_deltaR_elastic,15) - (0.0525))/(0.0525),...
