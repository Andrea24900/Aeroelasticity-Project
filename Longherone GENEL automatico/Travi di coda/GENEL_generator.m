...
fid = fopen('forza_e_momento.f06', 'r');
...
while ~feof(fid)
    ...
    if length(currentLine)>36
            if currentLine(1:26) == '         12001      G     '
                ...
                if a(1)>=N+1 && a(1) <=2*N
                    flessioni(1,a(1)-N) = str2double(currentLine(72:84));
                end
                if a(1)>=2*N+1
                    torsioni(1,a(1)-2*N) = str2double(currentLine(102:114));
                end
            end
            ...
            if currentLine(1:26) == '         12002      G     '
                ...
                if a(2)>=N+1 && a(2) <=2*N
                    flessioni(2,a(2)-N) = str2double(currentLine(72:84));
                end
                if a(2)>=2*N+1
                    torsioni(2,a(2)-2*N) = str2double(currentLine(102:114));
                end
            end
            ...
            if currentLine(1:26) == '         12003      G     '
                ...
                if a(3)>=N+1 && a(3) <=2*N
                    flessioni(3,a(3)-N) = str2double(currentLine(72:84));
                end
                if a(3)>=3*N+1
                    torsioni(3,a(3)-2*N) = str2double(currentLine(102:114));
                end
            end
            ...
            if currentLine(1:26) == '         12004      G     '
                ...
                if a(4)>=N+1 && a(4) <=2*N
                    flessioni(4,a(4)-N) = str2double(currentLine(72:84));
                end
                if a(4)>=2*N+1
                    torsioni(4,a(4)-2*N) = str2double(currentLine(102:114));
                end
            end
            ...
            if currentLine(1:26) == '         12005      G     '
                ...
                if a(5)>=N+1 && a(5) <=2*N
                    flessioni(5,a(5)-N) = str2double(currentLine(72:84));
                end
                if a(5)>=2*N+1
                    torsioni(5,a(5)-2*N) = str2double(currentLine(102:114));
                end
            end
            ...
            if currentLine(1:26) == '         12006      G     '
                ...
                if a(6)>=N+1 && a(6) <=2*N
                    flessioni(6,a(6)-N) = str2double(currentLine(72:84));
                end
                if a(6)>=2*N+1
                    torsioni(6,a(6)-2*N) = str2double(currentLine(102:114));
                end
            end
            ...
            if currentLine(1:26) == '         12007      G     '
                ...
                if a(7)>=N+1 && a(7) <=2*N
                    flessioni(7,a(7)-N) = str2double(currentLine(72:84));
                end
                if a(7)>=2*N+1
                    torsioni(7,a(7)-2*N) = str2double(currentLine(102:114));
                end
            end
            ...
            if currentLine(1:26) == '         12008      G     '
                ...
                if a(8)>=N+1 && a(8) <=2*N
                    flessioni(8,a(8)-N) = str2double(currentLine(72:84));
                end
                if a(8)>=2*N+1
                    torsioni(8,a(8)-2*N) = str2double(currentLine(102:114));
                end
            end
            ...
            if currentLine(1:26) == '         12009      G     '
                ...
                if a(9)>=N+1 && a(9) <=2*N
                    flessioni(9,a(9)-N) = str2double(currentLine(72:84));
                end
                if a(9)>=2*N+1
                    torsioni(9,a(9)-2*N) = str2double(currentLine(102:114));
                end
            end
...
for j = 1:N
    if j == 1
    stringa1 = [stringa1,num2str(j+10),'       3'];
    else
    stringa1 = [stringa1,'       ',num2str(j+10),'       3'];
    end
...
for j = 1:N
    if j == 1
    stringa1 = [stringa1,num2str(j+10),'       5'];
    else
    stringa1 = [stringa1,'       ',num2str(j+10),'       5'];
    end

    for i = j:N
        stringa5 = [stringa5,converti(flessioni(i,j))];
    end
end
[stringa1,righe] = vai_a_capo_nodi(stringa1);
for i = 1:righe
...
for j = 1:N
    if j == 1
    stringa1 = [stringa1,num2str(j+10),'       4'];
    else
    stringa1 = [stringa1,'       ',num2str(j+10),'       4'];
    end
